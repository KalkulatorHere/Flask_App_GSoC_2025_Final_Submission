...
class OCRModelsService:
    ...
    def load_trocr_model(self):
        ...
        if self.processor is None or self.model is None:
            ...
            try:
                self.processor = TrOCRProcessor.from_pretrained('qantev/trocr-large-spanish')
                self.model = VisionEncoderDecoderModel.from_pretrained('qantev/trocr-large-spanish')
